...
impl Engine for Game {
    ...
    fn render(&mut self, api: &mut dyn DoryenApi) {
        ...
        con.ascii((self.console_width/2) as i32, (self.console_height/2) as i32, '@' as u16);
        con.fore((self.console_width/2) as i32, (self.console_height/2) as i32, (255, 255, 255, 255));
        con.back(
